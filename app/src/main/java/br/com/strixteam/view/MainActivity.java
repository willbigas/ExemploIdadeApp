...
public class MainActivity extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        layoutRes = findViewById(R.id.layoutRes);
    }
...
//        });
    ...
    public void verificarAction(View view) {
        ...
        if (!PessoaBO.validarNome(pessoa.getNome())) {
            ...
            // COLOCANDO IMAGEM EM FORMA ESTATICA
...
//            // Formato Dinâmico
//            TextView tvResDinamico = new TextView(this);
//            tvResDinamico.setText("###Olá " + pessoa.getNome() + ", você possui " + pessoa.getIdade() + " ano(s)");
//            layoutRes.addView(tvResDinamico);
